    ...
    return (
      <div className="min-h-screen bg-white text-gray-800 p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">Loading payment configuration...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-blue-50 text-blue-700 border border-blue-200 hover:bg-blue-100 hover:text-blue-800 transition-all flex items-center gap-2"
            >
              {isEditing ? 'Cancel' : 'Edit Configuration'}
            </button>
            <button
              onClick={fetchPaymentConfig}
              className="px-4 py-2 rounded-xl bg-gray-100 text-gray-700 border border-gray-300 hover:bg-gray-200 hover:text-gray-800 transition-all flex items-center gap-2"
            >
              <RefreshCw size={16} />
              Refresh
            </button>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 mb-1">Global Configuration</p>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-6 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-bold text-gray-900">Admin Payment Setup</h2>
            </div>

            <form onSubmit={handleSaveConfig} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-gray-600 uppercase mb-2 ml-1">
                  Admin UPI ID *
                </label>
                <input 
                  type="text"
                  ...
                  disabled={!isEditing}
                  className="w-full bg-white border border-gray-300 rounded-xl p-3.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition-all text-gray-900 disabled:bg-gray-100 disabled:text-gray-500"
                  placeholder="merchant@upi"
                  required
                />
                <p className="text-xs text-gray-500 mt-1 ml-1">e.g., drivingschool@oksbi, merchant@ybl</p>
              </div>
              ...
              <div>
                ...
                {isEditing ? (
                  <div className="relative group border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 hover:bg-blue-50 transition-all">
                    <input 
                      type="file" 
                      accept="image/*"
                      ...
                      disabled={!isEditing}
                    />
                    <Upload className="mx-auto text-gray-500 group-hover:text-blue-600 mb-2" size={20} />
                  ...
                  <div className="border border-gray-200 rounded-xl p-4 text-center bg-white">
                    {paymentConfig.existingQrUrl ? (
                      <div>
                        <p className="text-sm text-gray-600 mb-2">QR Code is configured</p>
              ...
              {isEditing && (
                <div className="pt-4">
                  <button 
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-600/20 flex justify-center items-center gap-2 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {saving ? (
                      <>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg">
                  ...
                  <button
                    ...
                    className="p-2 hover:bg-blue-100 rounded-lg transition-colors text-gray-600 hover:text-blue-700"
                    title="Copy UPI ID"
                  >
                    <Copy size={16} />
                  </button>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-6">
            ...
            <div className="flex flex-col items-center justify-center py-8">
              {(paymentConfig.adminQrCode || paymentConfig.existingQrUrl) ? (
                <>
                  <div className="mb-6 border-4 border-gray-300 rounded-xl p-4 bg-white">
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML = `
                          <div class="text-center p-8">
                            <QrCode class="mx-auto mb-4 text-gray-400" size={64} />
                            <p class="text-sm text-gray-600">QR Code image not available</p>
                            <p class="text-xs text-gray-500 mt-1">Upload a new QR image</p>
                          </div>
                        `;
                      }}
                    />
                  ...
                  <button
                    ...
                    className="mt-4 px-4 py-2 bg-emerald-600 text-white text-sm rounded-lg hover:bg-emerald-700 transition-colors flex items-center gap-2"
                  >
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-600">No QR code uploaded yet</p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-3xl p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">QR Code Payment</h4>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">UPI ID Payment</h4>
                  <div className="flex items-center gap-2 mb-2">
                    <code className="text-sm font-mono bg-white border border-gray-300 px-3 py-1 rounded flex-1 truncate text-blue-700">
                      {paymentConfig.adminUpiId || 'Not configured'}
                    </code>
                    {paymentConfig.adminUpiId && (
                      <button
                        onClick={() => handleCopyToClipboard(paymentConfig.adminUpiId, 'UPI ID')}
                        className="p-2 hover:bg-blue-100 rounded text-gray-600 hover:text-blue-700"
                        title="Copy UPI ID"
                      >
                        <Copy size={14} />
                      </button>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-1">Phone Payment</h4>
                  <p className="text-sm text-gray-600">
                    ...
                    {paymentConfig.adminPhone && (
                      <button
                        onClick={() => handleCopyToClipboard(paymentConfig.adminPhone, 'Phone')}
                        className="ml-2 p-1 hover:bg-blue-100 rounded text-gray-600 hover:text-blue-700"
                        title="Copy Phone"
                      >
                        <Copy size={12} />
                      </button>
            ...
            <div className="mt-6 p-4 bg-white border border-gray-200 rounded-xl">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-bold text-gray-900">Important Note</span>
              </div>
              <p className="text-xs text-gray-600">
